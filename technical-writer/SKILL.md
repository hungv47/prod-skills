...
description: "This skill should be invoked when the user wants documentation for a codebase or project -- READMEs, user guides, API references, API docs, setup guides, runbooks, changelogs, or architecture docs. Triggers include 'write a README', 'document this', 'nobody knows how this works', 'I need docs', 'our docs are outdated', 'explain this codebase', 'create a user guide', 'knowledge base', 'it's all tribal knowledge', or 'developer onboarding documentation' -- even if they just say 'a new dev couldn't figure this out' or 'I'm the only one who knows how this works.' Not for specifying what to build (use plan-interviewer), cleaning up code (use code-cleanup), or user-facing onboarding UX (use user-flow)."
license: MIT
metadata:
  author: hungv47
  version: "2.1.0"
